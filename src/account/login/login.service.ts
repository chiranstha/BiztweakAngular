...
export class LoginService {
    ...
    authenticate(finallyCallback?: () => void, redirectUrl?: string, captchaResponse?: string): void {
        ...
        this._localStorageService.getItem(LoginService.twoFactorRememberClientTokenName, function (err, value) {
            ...
            self.authenticateModel.returnUrl = '/app/main/';
    ...
    private processAuthenticateResult(authenticateResult: AuthenticateResultModel, redirectUrl?: string) {
        ...
        if (authenticateResult.shouldResetPassword) {
            ...
            if (authenticateResult.userId === UserTypeEnum.Entrepreneur) {
                this._router.navigate(['/app/main/EnterpreneurDashboard']);
            }
            // if (this._sessionService.user.userType === UserTypeEnum.Encubator) {
            //     return '/encubator/dashboard';
            // }
            // if (this._sessionService.user.userType === UserTypeEnum.Entrepreneur) {
            //     return '/app/main/EnterpreneurDashboard';
            // }

            // if (this._sessionService.user.userType === UserTypeEnum.Coach ||
            //     this._sessionService.user.userType === UserTypeEnum.Mentors ||
            //     this._sessionService.user.userType === UserTypeEnum.Consultant){
            //     return '/app/main/EnterpreneurDashboard';
            // }
