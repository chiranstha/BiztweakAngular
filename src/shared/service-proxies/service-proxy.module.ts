...
@NgModule({
    providers: [
        ApiServiceProxies.LmsproritiesServiceProxy,        
        ApiServiceProxies.JobRecommendationsServiceProxy,        
        ApiServiceProxies.CourseRecommendationsServiceProxy,        
        ApiServiceProxies.JobsServiceProxy,        
        ApiServiceProxies.AssignmentTypesServiceProxy,        
        ApiServiceProxies.BusinessPhasesServiceProxy,          
        ApiServiceProxies.EntrepreneurProfileServiceProxy,     
        ApiServiceProxies.IncubatorServiceProxy,        
        ApiServiceProxies.EntrepreneurAssignmentServiceProxy,
        ApiServiceProxies.EntrepreneurAttendanceServiceProxy,
        ApiServiceProxies.DigitalResourceServiceProxy,
        ApiServiceProxies.DigitalCateogoriesServiceProxy,
        ApiServiceProxies.EntrepreneurStatesServiceProxy,
        ApiServiceProxies.GrowthPlansServiceProxy,
        ApiServiceProxies.BankServiceProxy,
        ApiServiceProxies.CompanyServiceProxy,
        ApiServiceProxies.EntrepreneursServiceProxy,
