...
import { IBizTweakPaginator, BizTweakPaginator } from '@app/shared/common/paginator/paginator.component';
...
export abstract class AppComponentBase implements OnDestroy {
    ...
    public biztweakRpag: IBizTweakPaginator = new BizTweakPaginator();
