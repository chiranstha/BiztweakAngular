...
export class JobSectionComponent extends AppComponentBase implements OnInit {
  @ViewChild('jobSectionModal', { static: true })
  jobSectionModal: jobSectionModalComponent;
