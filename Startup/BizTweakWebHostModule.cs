...
using BizTweak.Auditing;
using BizTweak.Authorization.Users.Password;
using BizTweak.Configuration;
using BizTweak.EntityFrameworkCore;
using BizTweak.MultiTenancy;
using BizTweak.Web.Startup.ExternalLoginInfoProviders;

namespace BizTweak.Web.Startup
{
    [DependsOn(
        typeof(BizTweakWebCoreModule)
    )]
    public class BizTweakWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public BizTweakWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BizTweakWebHostModule).GetAssembly());
        }
